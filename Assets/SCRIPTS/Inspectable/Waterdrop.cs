...
public class Waterdrop : MonoBehaviour {
    ...
    private Transform rootPointsParent;
    ...
    void Start() {
        rootPointsParent = GameObject.Find("RootPoints").transform;
        ...
        Transform[] rootPoints = rootPointsParent.GetComponentsInChildren<Transform>();
